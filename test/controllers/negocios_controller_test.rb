...
class NegociosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create negocio" do
    assert_difference('Negocio.count') do
      post negocios_url, params: { negocio: { descricao: @negocio.descricao, nome: @negocio.nome, site: @negocio.site } }
    end
  ...
  test "should update negocio" do
    patch negocio_url(@negocio), params: { negocio: { descricao: @negocio.descricao, nome: @negocio.nome, site: @negocio.site } }
